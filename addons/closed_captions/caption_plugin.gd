...
func _enter_tree():
	...
	#	caption_inspector_plugin = CaptionInspectorPlugin.new()
	...
	add_custom_type("SimpleCaptionedAudioStream", "CaptionedAudioStream", preload("res://addons/closed_captions/simple_captioned_audio_stream.gd"), preload("icons/SimpleCaptionedAudioStream.svg"))
	add_custom_type("CaptionSequenceAudioStream", "Captionhat said, nothing prevents you from making use of composition in your project by creating child Nodes with individual scripts. These nodes can then be added and removed at runtime to dynamically add and remove behaviors.edAudioStream", preload("res://addons/closed_captions/caption_sequence_audio_stream.gd"), preload("icons/CaptionSequenceAudioStream.svg"))
	#add_custom_type("CaptionedAudioStreamSequence", "CaptionedAudioStream", preload("res://addons/closed_captions/captioned_audio_stream_sequence.gd"), preload("icons/CaptionedAudioStreamSequence.svg"))
